...
enum TTCExecCtrl {
	ExecCtrlPrioTC, ExecCtrlReboot,ExecCtrlHK_FDIRTC, ExecCtrBGKTC
};
...
protected:
	...
	/**
	 * \brief Set mTCExecCtrl to ExecCtrlBGKTC
	 *
	 */

	void SetExecCtrlAsBGKTC() {

		mTCExecCtrl = ExecCtrBGKTC;
	}
...
public:
	...
	bool_t IsBGKTC() {
			return ExecCtrBGKTC == mTCExecCtrl;
	}
