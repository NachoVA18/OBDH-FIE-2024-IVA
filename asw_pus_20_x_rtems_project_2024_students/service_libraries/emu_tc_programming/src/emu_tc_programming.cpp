...
#define FT_SOLO_EPD_ICU_SERV_20_0060_TIME_step2 (UNITIME_AFTER_POWER_ON + 12)


EmuGSS_TCProgram20_1 prog_FT_0060_step_0(FT_SOLO_EPD_ICU_SERV_20_0060_TIME_step0,
"FT_SOLO_EPD_ICU_SERV_20_0060 step 0, Report param  1",1);

EmuGSS_TCProgram20_3 prog_FT_0060_step_1(FT_SOLO_EPD_ICU_SERV_20_0060_TIME_step1,
"FT_SOLO_EPD_ICU_SERV_20_0060 step 1, Set param 1 value to 0  1",1,0);

EmuGSS_TCProgram20_1 prog_FT_0060_step_2(FT_SOLO_EPD_ICU_SERV_20_0060_TIME_step2,
"FT_SOLO_EPD_ICU_SERV_20_0060 step 0, Report param  1",1);
